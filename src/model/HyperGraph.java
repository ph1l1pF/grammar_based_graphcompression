...
public class HyperGraph {
     ...
     */
    private HyperGraph(HashMap<Integer, GraphNode> nodes, HashMap<Integer, Edge> edges) {
        this.nodes = nodes;
        this.edges = edges;
    }
     ...
     */
    public void addAll(Map<Integer, GraphNode> newNodes) {
    ...
    public HyperGraph clone() {
        return new HyperGraph((HashMap<Integer, GraphNode>) getAllNodes().clone(), (HashMap<Integer, Edge>) getAllEdges().clone());
    }
     ...
     */
    public LinkedList<SimpleEdge> getAllIncidentEdges(GraphNode node) {
